  ...
  render() {
    return (
      <Main1 className="Discord">
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/S9CaB83z6z8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
